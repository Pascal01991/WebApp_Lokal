...
const postAppointment = async (req,res) => {
    try {
        ...
        const { title, description, Vorname, Nachname, Telefon, Mail, Dienstleistung, duration } = req.body;
        ...
        const newAppointment = new Appointment({ title, description, Vorname, Nachname, Telefon, Mail, Dienstleistung, duration });
